...
export const SelectStyle = () => {
  ...
  const { theme: { shadow, secondaryBackground, primary, accent, foreground }, fontSize, fontFamily } = useSelector(({ settings }: RootState) => settings);
    ...
    <Container>
      ...
      <PanelContainer>
        <Panel background={secondaryBackground} shadow={shadow} active={isOpen} color={foreground}>
          ...
          <div>Font Family</div>
          <Button primary={fontFamily !== FontFamily.QUICKSAND} fill color={fontFamily === FontFamily.QUICKSAND ? Color.WHITE : undefined} onClick={onFontFamilyClick(FontFamily.QUICKSAND)} fontFamily={FontFamily.QUICKSAND}>Quicksand</Button>
          <Button primary={fontFamily !== FontFamily.PT_SANS} fill color={fontFamily === FontFamily.PT_SANS ? Color.WHITE : foreground} onClick={onFontFamilyClick(FontFamily.PT_SANS)} fontFamily={FontFamily.PT_SANS}>PT Sans</Button>
          <Button primary={fontFamily !== FontFamily.PT_SERIF} fill color={fontFamily === FontFamily.PT_SERIF ? Color.WHITE : foreground} onClick={onFontFamilyClick(FontFamily.PT_SERIF)} fontFamily={FontFamily.PT_SERIF}>PT Serif</Button>
